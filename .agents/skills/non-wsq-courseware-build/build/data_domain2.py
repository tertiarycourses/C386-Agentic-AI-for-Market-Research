...
DOMAIN2 = [
    dict(
        ...
        steps=[
            ...
            ("Run the evidence, voice, privacy, rights, relevance, and action-boundary checks. Add a Review Log with at least one substantive human rewrite and one rejected AI suggestion.", "| Artefact | Check | Source or rule | Result | Human change | Status |"),
        ],
        slide_steps=[
        ...
        test=(
            ...
            "Every factual claim must map to an approved source or be removed, each draft must contain a documented human edit, and no item may be marked for publication."
        ),
